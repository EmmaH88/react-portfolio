  ...
  return (
    <div name="home" className=" w-full h-screen bg-[#141010]">
      <div className="max-w-[1000px] mx-auto px-10 flex flex-col justify-center h-full">
        ...
        <p className="text-[#F70776] text-xl  py-4 max-w-[700px]">
        ...
        <div>
          <button className="text-[#F70776] group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#141010] hover:border-pink-600">
            View My Work
